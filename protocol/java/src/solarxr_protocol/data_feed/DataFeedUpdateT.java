...
public class DataFeedUpdateT {
  ...
  public int getStayAlignedPose() { return stayAlignedPose; }

  public void setStayAlignedPose(int stayAlignedPose) { this.stayAlignedPose = stayAlignedPose; }
