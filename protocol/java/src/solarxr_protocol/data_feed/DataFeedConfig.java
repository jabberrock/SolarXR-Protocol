...
public final class DataFeedConfig extends Table {
  ...
  public boolean stayAlignedMask() { int o = __offset(12); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  ...
  public static int createDataFeedConfig(FlatBufferBuilder builder,
    ...
    DataFeedConfig.addStayAlignedMask(builder, stayAlignedMask);
  ...
  public static void addStayAlignedMask(FlatBufferBuilder builder, boolean stayAlignedMask) { builder.addBoolean(4, stayAlignedMask, false); }
  ...
  public void unpackTo(DataFeedConfigT _o) {
    ...
    boolean _oStayAlignedMask = stayAlignedMask();
    _o.setStayAlignedMask(_oStayAlignedMask);
  }
