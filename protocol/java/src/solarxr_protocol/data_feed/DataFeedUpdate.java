...
public final class DataFeedUpdate extends Table {
  ...
  public solarxr_protocol.data_feed.device_data.DeviceData devices(int j) { return devices(new solarxr_protocol.data_feed.device_data.DeviceData(), j); }
  public solarxr_protocol.data_feed.device_data.DeviceData devices(solarxr_protocol.data_feed.device_data.DeviceData obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
   ...
   */
  public solarxr_protocol.data_feed.Bone bones(int j) { return bones(new solarxr_protocol.data_feed.Bone(), j); }
  public solarxr_protocol.data_feed.Bone bones(solarxr_protocol.data_feed.Bone obj, int j) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public int stayAlignedPose() { int o = __offset(10); return o != 0 ? bb.get(o + bb_pos) & 0xFF : 0; }
  ...
  public static void addStayAlignedPose(FlatBufferBuilder builder, int stayAlignedPose) { builder.addByte(3, (byte) stayAlignedPose, (byte) 0); }
  ...
  public void unpackTo(DataFeedUpdateT _o) {
    ...
    _o.setBones(_oBones);
    int _oStayAlignedPose = stayAlignedPose();
    _o.setStayAlignedPose(_oStayAlignedPose);
  }
  public static int pack(FlatBufferBuilder builder, DataFeedUpdateT _o) {
    ...
    if (_o.getDevices() != null) {
      ...
      int _j = 0;
      for (solarxr_protocol.data_feed.device_data.DeviceDataT _e : _o.getDevices()) { __devices[_j] = solarxr_protocol.data_feed.device_data.DeviceData.pack(builder, _e); _j++;}
