...
public final class TrackerData extends Table {
   ...
   * Stay Aligned
   */
  public solarxr_protocol.data_feed.StayAlignedState stayAligned() { return stayAligned(new solarxr_protocol.data_feed.StayAlignedState()); }
  public solarxr_protocol.data_feed.StayAlignedState stayAligned(solarxr_protocol.data_feed.StayAlignedState obj) { int o = __offset(28); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public static int pack(FlatBufferBuilder builder, TrackerDataT _o) {
    ...
    int _stayAligned = _o.getStayAligned() == null ? 0 : solarxr_protocol.data_feed.StayAlignedState.pack(builder, _o.getStayAligned());
