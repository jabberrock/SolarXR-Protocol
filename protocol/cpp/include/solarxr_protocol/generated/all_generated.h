...
struct StayAlignedData;
struct StayAlignedDataBuilder;
...
enum class RpcMessage : uint8_t {
  ...
  EnableStayAlignedRequest = 66,
  DetectStayAlignedRelaxedPoseRequest = 67,
  ResetStayAlignedRelaxedPoseRequest = 68,
  MIN = NONE,
  MAX = ResetStayAlignedRelaxedPoseRequest
};

inline const RpcMessage (&EnumValuesRpcMessage())[69] {
...
struct StayAlignedData FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef StayAlignedDataBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
...
struct StayAlignedDataBuilder {
  typedef StayAlignedData Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_upper_leg_angle_in_deg(float upper_leg_angle_in_deg) {
    fbb_.AddElement<float>(StayAlignedData::VT_UPPER_LEG_ANGLE_IN_DEG, upper_leg_angle_in_deg, 0.0f);
  }
  void add_lower_leg_angle_in_deg(float lower_leg_angle_in_deg) {
    fbb_.AddElement<float>(StayAlignedData::VT_LOWER_LEG_ANGLE_IN_DEG, lower_leg_angle_in_deg, 0.0f);
  }
  void add_foot_angle_in_deg(float foot_angle_in_deg) {
    fbb_.AddElement<float>(StayAlignedData::VT_FOOT_ANGLE_IN_DEG, foot_angle_in_deg, 0.0f);
  }
  explicit StayAlignedDataBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  flatbuffers::Offset<StayAlignedData> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<StayAlignedData>(end);
    return o;
  }
};

inline flatbuffers::Offset<StayAlignedData> CreateStayAlignedData(
    flatbuffers::FlatBufferBuilder &_fbb,
    float upper_leg_angle_in_deg = 0.0f,
    float lower_leg_angle_in_deg = 0.0f,
    float foot_angle_in_deg = 0.0f) {
  StayAlignedDataBuilder builder_(_fbb);
...
struct DataFeedUpdate FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const solarxr_protocol::data_feed::stay_aligned::StayAlignedData *stay_aligned() const {
    return GetPointer<const solarxr_protocol::data_feed::stay_aligned::StayAlignedData *>(VT_STAY_ALIGNED);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct DataFeedUpdateBuilder {
  ...
  void add_stay_aligned(flatbuffers::Offset<solarxr_protocol::data_feed::stay_aligned::StayAlignedData> stay_aligned) {
    fbb_.AddOffset(DataFeedUpdate::VT_STAY_ALIGNED, stay_aligned);
  }
...
inline flatbuffers::Offset<DataFeedUpdate> CreateDataFeedUpdate(
    ...
    flatbuffers::Offset<solarxr_protocol::data_feed::stay_aligned::StayAlignedData> stay_aligned = 0) {
...
struct DataFeedConfig FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool stay_aligned_mask() const {
    return GetField<uint8_t>(VT_STAY_ALIGNED_MASK, 0) != 0;
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint8_t>(verifier, VT_STAY_ALIGNED_MASK, 1) &&
           verifier.EndTable();
  }
};
...
struct DataFeedConfigBuilder {
  ...
  void add_stay_aligned_mask(bool stay_aligned_mask) {
    fbb_.AddElement<uint8_t>(DataFeedConfig::VT_STAY_ALIGNED_MASK, static_cast<uint8_t>(stay_aligned_mask), 0);
  }
...
inline flatbuffers::Offset<DataFeedConfig> CreateDataFeedConfig(
  ...
  builder_.add_stay_aligned_mask(stay_aligned_mask);
...
struct StayAlignedSettings FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_STANDINGUPPERLEGANGLE = 10,
    VT_STANDINGLOWERLEGANGLE = 12,
    VT_STANDINGFOOTANGLE = 14,
    VT_SITTINGUPPERLEGANGLE = 16,
    VT_SITTINGLOWERLEGANGLE = 18,
    VT_SITTINGFOOTANGLE = 20,
    VT_FLATUPPERLEGANGLE = 22,
    VT_FLATLOWERLEGANGLE = 24,
    VT_FLATFOOTANGLE = 26
  };
  bool enabled() const {
    return GetField<uint8_t>(VT_ENABLED, 0) != 0;
