...
impl<'a> StayAlignedSettings<'a> {
  ...
  pub const VT_STANDINGUPPERLEGANGLE: flatbuffers::VOffsetT = 10;
  pub const VT_STANDINGLOWERLEGANGLE: flatbuffers::VOffsetT = 12;
  pub const VT_STANDINGFOOTANGLE: flatbuffers::VOffsetT = 14;
  pub const VT_SITTINGUPPERLEGANGLE: flatbuffers::VOffsetT = 16;
  pub const VT_SITTINGLOWERLEGANGLE: flatbuffers::VOffsetT = 18;
  pub const VT_SITTINGFOOTANGLE: flatbuffers::VOffsetT = 20;
  pub const VT_FLATUPPERLEGANGLE: flatbuffers::VOffsetT = 22;
  pub const VT_FLATLOWERLEGANGLE: flatbuffers::VOffsetT = 24;
  pub const VT_FLATFOOTANGLE: flatbuffers::VOffsetT = 26;
