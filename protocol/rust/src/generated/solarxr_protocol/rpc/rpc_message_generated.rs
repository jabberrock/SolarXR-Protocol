...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_RPC_MESSAGE: u8 = 66;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_RPC_MESSAGE: [RpcMessage; 67] = [
  RpcMessage::NONE,
...
impl RpcMessage {
  ...
  pub const DetectStayAlignedRelaxedPoseRequest: Self = Self(65);
  pub const ResetStayAlignedRelaxedPoseRequest: Self = Self(66);
