...
impl RpcMessage {
  ...
  pub const RecordPFSRequest: Self = Self(79);
  pub const RecordPFSResponse: Self = Self(80);
  ...
  pub const ENUM_VALUES: &'static [Self] = &[
    ...
    Self::RecordPFSRequest,
    Self::RecordPFSResponse,
  ];
  ...
  pub fn variant_name(self) -> Option<&'static str> {
    match self {
      ...
      Self::RecordPFSRequest => Some("RecordPFSRequest"),
      Self::RecordPFSResponse => Some("RecordPFSResponse"),
      _ => None,
    }
  }
}
