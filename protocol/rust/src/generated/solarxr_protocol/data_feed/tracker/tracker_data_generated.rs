...
impl<'a> TrackerData<'a> {
  ...
  /// Stay Aligned
  #[inline]
  pub fn stay_aligned(&self) -> Option<super::StayAlignedState<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<super::StayAlignedState>>(TrackerData::VT_STAY_ALIGNED, None)}
  }
}
...
impl flatbuffers::Verifiable for TrackerData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<super::StayAlignedState>>("stay_aligned", Self::VT_STAY_ALIGNED, false)?
     .finish();
    Ok(())
  }
}
pub struct TrackerDataArgs<'a> {
    ...
    pub tps: Option<u16>,
    pub stay_aligned: Option<flatbuffers::WIPOffset<super::StayAlignedState<'a>>>,
}
...
impl<'a: 'b, 'b> TrackerDataBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_stay_aligned(&mut self, stay_aligned: flatbuffers::WIPOffset<super::StayAlignedState<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<super::StayAlignedState>>(TrackerData::VT_STAY_ALIGNED, stay_aligned);
  }
  #[inline]
