...
impl<'a> DataFeedConfig<'a> {
  ...
  pub const VT_STAY_ALIGNED_MASK: flatbuffers::VOffsetT = 12;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    builder.add_stay_aligned_mask(args.stay_aligned_mask);
  ...
  #[inline]
  pub fn stay_aligned_mask(&self) -> bool {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(DataFeedConfig::VT_STAY_ALIGNED_MASK, Some(false)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for DataFeedConfig<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<bool>("stay_aligned_mask", Self::VT_STAY_ALIGNED_MASK, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> DataFeedConfigBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_stay_aligned_mask(&mut self, stay_aligned_mask: bool) {
    self.fbb_.push_slot::<bool>(DataFeedConfig::VT_STAY_ALIGNED_MASK, stay_aligned_mask, false);
  }
  #[inline]
...
impl core::fmt::Debug for DataFeedConfig<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("DataFeedConfig");
      ...
      ds.field("stay_aligned_mask", &self.stay_aligned_mask());
      ds.finish()
  }
}
