...
impl<'a> DataFeedUpdate<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    builder.add_stay_aligned_pose(args.stay_aligned_pose);
    builder.finish()
  }
  ...
  #[inline]
  pub fn stay_aligned_pose(&self) -> StayAlignedPose {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<StayAlignedPose>(DataFeedUpdate::VT_STAY_ALIGNED_POSE, Some(StayAlignedPose::UNKNOWN)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for DataFeedUpdate<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<StayAlignedPose>("stay_aligned_pose", Self::VT_STAY_ALIGNED_POSE, false)?
     .finish();
    Ok(())
  }
}
pub struct DataFeedUpdateArgs<'a> {
    ...
    pub stay_aligned_pose: StayAlignedPose,
}
impl<'a> Default for DataFeedUpdateArgs<'a> {
  ...
  fn default() -> Self {
    DataFeedUpdateArgs {
      ...
      bones: None,
      stay_aligned_pose: StayAlignedPose::UNKNOWN,
    }
  }
}
...
impl<'a: 'b, 'b> DataFeedUpdateBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_stay_aligned_pose(&mut self, stay_aligned_pose: StayAlignedPose) {
    self.fbb_.push_slot::<StayAlignedPose>(DataFeedUpdate::VT_STAY_ALIGNED_POSE, stay_aligned_pose, StayAlignedPose::UNKNOWN);
  }
  #[inline]
