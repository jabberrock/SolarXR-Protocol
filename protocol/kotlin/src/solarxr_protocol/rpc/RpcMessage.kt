...
class RpcMessage private constructor() {
    companion object {
        ...
        const val ConnectToVideoCalibrationRequest: UByte = 86u
        const val ConnectToVideoCalibrationResponse: UByte = 87u
        const val StartVideoCalibrationRequest: UByte = 88u
        const val VideoCalibrationProgress: UByte = 89u
        const val VideoCalibrationError: UByte = 90u
