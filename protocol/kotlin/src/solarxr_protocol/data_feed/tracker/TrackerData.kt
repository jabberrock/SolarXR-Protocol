...
class TrackerData : Table() {
     ...
     * Stay Aligned
     */
    val stayAligned : solarxr_protocol.data_feed.StayAlignedState? get() = stayAligned(solarxr_protocol.data_feed.StayAlignedState())
    fun stayAligned(obj: solarxr_protocol.data_feed.StayAlignedState) : solarxr_protocol.data_feed.StayAlignedState? {
        val o = __offset(28)
        return if (o != 0) {
            obj.__assign(__indirect(o + bb_pos), bb)
        } else {
    ...
    companion object {
        ...
        @JvmStatic
        fun addStayAligned(builder: FlatBufferBuilder, stayAligned: Int) = builder.addOffset(12, stayAligned, 0)
        @JvmStatic
