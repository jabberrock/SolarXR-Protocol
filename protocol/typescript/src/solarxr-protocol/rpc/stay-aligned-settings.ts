...
static createStayAlignedSettings(builder:flatbuffers.Builder, enabled:boolean, extraYawCorrection:boolean, hideYawCorrection:boolean, standingUpperLegAngle:number, standingLowerLegAngle:number, standingFootAngle:number, sittingUpperLegAngle:number, sittingLowerLegAngle:number, sittingFootAngle:number, flatUpperLegAngle:number, flatLowerLegAngle:number, flatFootAngle:number):flatbuffers.Offset {
