...
static addStayAlignedMask(builder:flatbuffers.Builder, stayAlignedMask:boolean) {
  builder.addFieldInt8(4, +stayAlignedMask, +false);
}
...
unpackTo(_o: DataFeedConfigT): void {
  ...
  _o.stayAlignedMask = this.stayAlignedMask();
}
}
...
constructor(
  ...
  public stayAlignedMask: boolean = false
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  DataFeedConfig.addStayAlignedMask(builder, this.stayAlignedMask);
