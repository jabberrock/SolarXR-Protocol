...
import { StayAlignedState, StayAlignedStateT } from '../../../solarxr-protocol/data-feed/stay-aligned-state.js';
 ...
 * Stay Aligned
 */
stayAligned(obj?:StayAlignedState):StayAlignedState|null {
  const offset = this.bb!.__offset(this.bb_pos, 28);
  return offset ? (obj || new StayAlignedState()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
}
...
static addStayAligned(builder:flatbuffers.Builder, stayAlignedOffset:flatbuffers.Offset) {
  builder.addFieldOffset(12, stayAlignedOffset, 0);
}
...
constructor(
  ...
  public stayAligned: StayAlignedStateT|null = null
){}
